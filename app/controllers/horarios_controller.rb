class HorariosController < ApplicationController
  ...
  private
    ...
    def horario_params
      params.require(:horario).permit(:from,:to,:student_id,
      :materias_attributes =>[:id,:_destroy,:order_id,:tutor_id,:horario_id,:name,:at_date,
      :at_time,:duration,:topic,:wdays,wdays:[]])
    end
end
