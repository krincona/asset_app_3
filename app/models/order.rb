...
class Order < ActiveRecord::Base
  ...
  TARIFA_PAY   = {"Anterior"=>{1=>18000,2=>20000,3=>23000},"Colegio"=>{1=>20000,2=>25000,3=>30000},"Curso"=>{1=>25000,2=>30000,3=>35000},"ICFES"=>{1=>20000,2=>25000,3=>30000},"Univ"=>{1=>25000,2=>30000,3=>35000}}
...
=end
  ...
  def calculate_price_amounts#en uso 2018
    if !self.materias.empty?
      ...
      self.subtotal_admin      = (self.sale_price - self.subtotal_tutoria)/1.19
